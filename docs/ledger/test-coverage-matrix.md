...
| `src/plugins/conn_provider_local.rs` | 3 | 2 | 1 | PLUGIN_NAME |
| `src/plugins/conn_provider_ws.rs` | 3 | 2 | 1 | PLUGIN_NAME |
| `src/plugins/input_ime.rs` | 2 | 1 | 1 | PLUGIN_NAME |
| `src/plugins/term_alacritty.rs` | 3 | 2 | 1 | PLUGIN_NAME |
...
| `src/termview.rs` | 76 | 69 | 7 | FONT_CANDIDATES CJK_FONT_CANDIDATES load_cjk_font font_probe KEYBAR_LABEL MAG_HALF_COLS MAG_HALF_ROWS |
